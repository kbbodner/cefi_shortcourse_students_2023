...
source(here::here("./CaseStudy_Covid19/covid-on/R/tmbstan_tools.R")) # some custom tools for connecting McMasterPandemic and Stan, they're documented fully in that file
