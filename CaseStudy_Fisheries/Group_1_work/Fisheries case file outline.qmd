...
We investigated model parameters to identify reasons our predictions were so low. The temperature covariate model is lowest, but all 3 values are low, indicating an anomaly in the S (spawners) variable. 

>>>>>>> 68e627955028aabaf0e095130ca9fa9e2435ce3d
