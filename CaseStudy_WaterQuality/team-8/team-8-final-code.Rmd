...
targets <- read_csv(here("./CaseStudy_WaterQuality/team-8/Data/targets-neon-chla.csv"))
...
evo_dt <- read.csv(here("./CaseStudy_WaterQuality/Data/targets-neon-chla_evaluation.csv"))
head(evo_dt)
evo_dt_sorted <- evo_dt[order(evo_dt$observation, decreasing = TRUE),]
head(evo_dt_sorted)
...
ggsave(here("./CaseStudy_WaterQuality/team-8/figures/Q4.jpg"))
```
